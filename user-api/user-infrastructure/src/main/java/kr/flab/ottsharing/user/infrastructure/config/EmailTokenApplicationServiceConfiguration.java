...
public class EmailTokenApplicationServiceConfiguration {
    ...
    @Bean
    public EmailTokenProcessor emailTokenProcessor(EmailTokenRepository emailTokenRepository, EventPublisher eventPublisher) {
        return new EmailTokenProcessor(emailTokenRepository, eventPublisher);
    }
}
